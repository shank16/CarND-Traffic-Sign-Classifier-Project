...
As a first step, I decided to do data augmentation process where I applied random brightness, rotation, translation affine function etc. and then I add the data with the data tranformation process, described earlier.

Here id the example of data augmentation process:
![alt text][image9]
